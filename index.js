    ...
    if (userMsg.content.slice(0,1) === "!")
    {
        if ((userMsg.content.slice(8,9) === "_") && (userMsg.content.slice(12,13) === "_") && (ppdictionary[userMsg.content.slice(4,8)] != undefined))
        {
            if ((userMsg.content.slice(1,3) === "AL" || userMsg.content.slice(1,3) === "AS")){
                ...
                userMsg.reply("Unexpected input. Use !help for a list of valid commands.")
                return -1
            }
            ...
            userMsg.reply("Incorrect paper code entered. Use !help to see a list of commands")
        }
    }
})
...
// client.on("message", userMsg => {
//     if(userMsg.content.slice(0,5) === "$bruh"){

//         const file = fs.createWriteStream("file.pdf");
//         const newrequest = https.get("https://papers.gceguide.com/A%20Levels/Physics%20(9702)/2017/9702_w17_qp_21.pdf", function(response) {
//             response.pipe(file);
//         });
        
//         let searchword = "variation"
//         setTimeout(() => {
...
//                 initializingIndex = realText.lastIndexOf("[Total: ", index)
